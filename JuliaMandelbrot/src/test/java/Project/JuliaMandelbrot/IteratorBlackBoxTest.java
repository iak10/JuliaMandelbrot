...
public class IteratorBlackBoxTest {
	 ...
	 * complex numbers into lists according to how many iterations of z := z^2 + c are required to diverge
	 * them to a distance > 2 from the origin. This enabled complete coverage for the correct selection of the 
	 * colour returned. All cases are tested up to iterations = 16, after which values on the cut-offs and on 
	 * either side of the cut-offs tested. The value of C = -0.0722 - 0.6675i is used. 
	 */
	@Test
	public void testA() {
		double reC = -0.0722; 
	 ...
	 * either side of the cut-offs are tested. The value C = -0.7061 - 0.2737i is used.
	 */
	@Test
	public void testB() {
		double reC = -0.7061; 
	...
	/** This test checks that the correct colour is returned for values of Z_0 
	 *  used in the Maple 12 work sheet data2
	 */
	@Test
	public void testOne() {
	...
	/** This test checks that the correct colour is returned for values of Z_0 
	 *  used in the Maple 12 work sheet data2, using a different array of cut-offs 
	 *  and colours from those used in testOne
	 */
	@Test
	public void testTwo() {
